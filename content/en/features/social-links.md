...
Social links are rendered at the bottom of the side pane on the home page and single pages. They are defined in the file at `data/ferro/socials.yaml`, where each entry is a list item:
