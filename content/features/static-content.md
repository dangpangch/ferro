...
Some of the static content on the site, like the home greetings and side pane content, can be defined in the file at `data/hugopress/content.yaml`. The structure to do so is as follows:
